I was responsible for implementing the mean calculation function. 
The contribution involved calculating the total sum of all values in the dataset and dividing the sum by the number of values. 
I also tested the function using the provided dataset to ensure that the calculated mean was correct.
...
2. ENGWAU JOTHAM – Variance Calculation

ENGWAU was responsible for implementing the variance calculation function. The contribution involved obtaining the mean of the dataset, calculating the difference between each value and the mean, squaring the differences, and calculating the sample variance. The function was tested to ensure that it produced the expected result.

3. KISAKYE JEMIMAH – Standard Deviation Calculation
